...
export declare class ParameterGenerator {
    ...
    private getUploadedFileParameter(parameter);
    private getUploadedFilesParameter(parameter);
    private getFormFieldParameter(parameter);
    private getParameterDescription(node);
    private supportBodyMethod(method);
    private supportParameterDecorator(decoratorName);
    private supportParameterType(parameterType);
