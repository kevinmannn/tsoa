...
var RouteGenerator = (function () {
    ...
    RouteGenerator.prototype.buildContent = function (middlewareTemplate, pathTransformer) {
        ...
        return routesTemplate({
            ...
            controllers: this.metadata.Controllers.map(function (controller) {
                return {
                    actions: controller.methods.map(function (method) {
                        ...
                        var uploadFileParameter = method.parameters.find(function (parameter) { return parameter.type.typeName === 'file'; });
                        var uploadFilesParameter = method.parameters.find(function (parameter) { return parameter.type.typeName === 'file[]'; });
                        return {
            ...
            useFileUploads: this.metadata.Controllers.some(function (controller) { return controller.methods.some(function (method) { return !!method.parameters.find(function (parameter) { return parameter.type.typeName === 'file' || parameter.type.typeName === 'file[]'; }); }); }),
